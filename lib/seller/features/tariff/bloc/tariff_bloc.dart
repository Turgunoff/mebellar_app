        ...
        state.copyWith(
          snapshot: snap == null
              ...
              : TariffSnapshot(
                  ...
                  // The poll only carries the plan code; the subscription
                  // window is only still valid if the plan didn't change
                  // underneath us.
                  startedAt: event.plan == snap.plan ? snap.startedAt : null,
