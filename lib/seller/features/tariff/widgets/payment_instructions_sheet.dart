...
class _SheetBodyState extends State<_SheetBody> {
  ...
  Future<void> _openTelegram(String url) async {
    ...
    if (!ok && mounted) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text(tr('shop.telegram_failed'))));
    }
  }
              ...
              builder: (context, snap) {
                ...
                return ListView(
                  ...
                  children: [
                    ...
                    if (RemoteConfig.instance.anyOnlineProviderVisible) ...[
                          ...
                          child: PaymentProviderTile(
                            ...
                            onTap:
                                RemoteConfig.instance.clickEnabled &&
                                    _launchingProvider == null
                                ? () => _payOnline(PaymentProvider.click)
                                : null,
                          ),
                        ),
                      const SizedBox(height: 20),
                    ...
                    SizedBox(
                      ...
                      child: FilledButton.icon(
                        onPressed:
                            ...
                            : null,
                        icon: state.status == TariffUpgradeFlowStatus.submitting
                            ? const SizedBox(
                                width: 16,
                                height: 16,
