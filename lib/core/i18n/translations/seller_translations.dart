...
const Map<String, dynamic> sellerUz = {
  ...
  'ar_scan_card_title': '3D skan (AR)',
  'info_tooltip': 'Ma’lumot',
  'ar_scan_card_description': 'Har bir qism uchun alohida model. Birinchi skan bepul, qaytasi 1 token.',
  ...
  'ar_part_processing': 'AI 3D model yasamoqda…',
  ...
  'ar_part_ready_to_scan': 'Skan qilishga tayyor',
  'ar_part_retry': 'Qayta',
  'ar_part_create': 'Yaratish',
...
const Map<String, dynamic> sellerRu = {
  ...
  'ar_scan_card_title': '3D-скан (AR)',
  'info_tooltip': 'Информация',
  'ar_scan_card_description': 'Отдельная модель для каждой части. Первый скан бесплатно, повторный — 1 токен.',
  ...
  'ar_part_processing': 'ИИ создаёт 3D-модель…',
  ...
  'ar_part_ready_to_scan': 'Готово к сканированию',
  'ar_part_retry': 'Заново',
  'ar_part_create': 'Создать',
...
const Map<String, dynamic> sellerEn = {
  ...
  'ar_scan_card_title': '3D scan (AR)',
  'info_tooltip': 'Info',
  'ar_scan_card_description': 'A separate model for each part. The first scan is free, a rescan costs 1 token.',
  ...
  'ar_part_processing': 'AI is generating the 3D model…',
  ...
  'ar_part_ready_to_scan': 'Ready to scan',
  'ar_part_retry': 'Retry',
  'ar_part_create': 'Create',
