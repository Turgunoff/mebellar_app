...
const Map<String, dynamic> sellerUz = {
  ...
  'ar_select_package_hint': 'Token paketini tanlang.',
  'payment_method': 'To‘lov usuli',
  'ar_pay_mode_online': 'To‘lov tizimlari',
  'ar_pay_mode_card': 'Kartaga o‘tkazish',
  'payment_unavailable': 'To‘lov usullari hozircha mavjud emas',
  ...
  'profile_contract_title': 'Ommaviy Oferta',
  'profile_contract_subtitle': 'Shartnoma va qoidalar',
  'profile_contract_accepted_date': 'Tasdiqlangan sana: {}',
  'profile_contract_version': 'Versiya: {}',
  'profile_contract_pdf_download': 'PDF formatida yuklab olish',
  'profile_contract_pdf_failed': 'PDF yaratib bo\'lmadi',
  ...
  'wallet_withdraw_section_subtitle':
      'Summa va karta raqamini kiriting — adminlar tez orada ko\'rib chiqadi.',
  'wallet_card_number_label': 'Karta raqami',
  'wallet_withdraw_button': 'Yuborish',
  'wallet_withdraw_submitting': 'Yuborilmoqda…',
  'wallet_withdraw_success':
      'So\'rov yuborildi. Adminlar tez orada ko\'rib chiqadi.',
  'wallet_withdraw_failed': 'Pul yechish so\'rovini yuborib bo\'lmadi.',
  'wallet_withdraw_insufficient': 'Balansda yetarli mablag\' yo\'q.',
  'wallet_withdraw_enter_card': 'Karta raqamini kiriting (16 raqam).',
  'wallet_withdraw_enter_amount': 'Yechiladigan summani kiriting.',
  'wallet_withdraw_amount_too_high': 'Summa joriy balansdan oshmasligi kerak.',
  'wallet_withdrawals_title': 'Pul yechish so\'rovlari',
  'wallet_withdrawal_status_pending': 'Kutilmoqda',
  'wallet_withdrawal_status_approved': 'Tasdiqlandi',
  'wallet_withdrawal_status_rejected': 'Rad etildi',
  ...
  'ar_purchase_status_pending_review': 'Ko‘rib chiqilmoqda',
  'ar_purchase_status_rejected': 'Rad etildi',
  'ar_purchase_provider_manual': 'Karta orqali',
  'ar_manual_submit': 'To‘lov qildim',
  'ar_manual_submitted':
      'So‘rovingiz yuborildi — admin tasdiqlagach tokenlar qo‘shiladi.',
  'ar_manual_failed': 'Yuborib bo‘lmadi. Qayta urinib ko‘ring.',
  'ar_manual_receipt_selected': 'Chek tanlandi',
  ...
  'ar_purchase_cancel_success': 'Xarid bekor qilindi',
  'ar_purchase_cancel_failed': 'Bekor qilib bo‘lmadi. Qayta urinib ko‘ring.',
...
const Map<String, dynamic> sellerRu = {
  ...
  'ar_select_package_hint': 'Выберите пакет токенов.',
  'payment_method': 'Способ оплаты',
  'ar_pay_mode_online': 'Платёжные системы',
  'ar_pay_mode_card': 'Перевод на карту',
  'payment_unavailable': 'Способы оплаты временно недоступны',
  ...
  'profile_contract_title': 'Публичная оферта',
  'profile_contract_subtitle': 'Договор и правила',
  'profile_contract_accepted_date': 'Дата подтверждения: {}',
  'profile_contract_version': 'Версия: {}',
  'profile_contract_pdf_download': 'Скачать в формате PDF',
  'profile_contract_pdf_failed': 'Не удалось создать PDF',
  ...
  'wallet_withdraw_section_subtitle':
      'Введите сумму и номер карты — администраторы скоро рассмотрят заявку.',
  'wallet_card_number_label': 'Номер карты',
  'wallet_withdraw_button': 'Отправить',
  'wallet_withdraw_submitting': 'Отправляем…',
  'wallet_withdraw_success':
      'Заявка отправлена. Администраторы скоро её рассмотрят.',
  'wallet_withdraw_failed': 'Не удалось отправить заявку на вывод.',
  'wallet_withdraw_insufficient': 'Недостаточно средств на балансе.',
  'wallet_withdraw_enter_card': 'Введите номер карты (16 цифр).',
  'wallet_withdraw_enter_amount': 'Введите сумму вывода.',
  'wallet_withdraw_amount_too_high':
      'Сумма не должна превышать текущий баланс.',
  'wallet_withdrawals_title': 'Заявки на вывод',
  'wallet_withdrawal_status_pending': 'Ожидает',
  'wallet_withdrawal_status_approved': 'Подтверждено',
  'wallet_withdrawal_status_rejected': 'Отклонено',
  'ar_tokens_finish_payment_notice':
  ...
  'ar_purchase_status_pending_review': 'На проверке',
  'ar_purchase_status_rejected': 'Отклонено',
  'ar_purchase_provider_manual': 'Перевод на карту',
  'ar_manual_submit': 'Я оплатил',
  'ar_manual_submitted':
      'Заявка отправлена — токены будут начислены после подтверждения.',
  'ar_manual_failed': 'Не удалось отправить. Попробуйте снова.',
  'ar_manual_receipt_selected': 'Чек выбран',
  'ar_purchase_provider_payme': 'Payme',
  'ar_purchase_provider_click': 'Click',
  ...
  'ar_purchase_cancel_success': 'Покупка отменена',
  'ar_purchase_cancel_failed': 'Не удалось отменить. Попробуйте ещё раз.',
...
const Map<String, dynamic> sellerEn = {
  ...
  'ar_select_package_hint': 'Select a token package.',
  'payment_method': 'Payment method',
  'ar_pay_mode_online': 'Payment apps',
  'ar_pay_mode_card': 'Card transfer',
  'payment_unavailable': 'Payment methods are temporarily unavailable',
  ...
  'profile_contract_title': 'Public Agreement',
  'profile_contract_subtitle': 'Contract and terms',
  'profile_contract_accepted_date': 'Accepted on: {}',
  'profile_contract_version': 'Version: {}',
  'profile_contract_pdf_download': 'Download as PDF',
  'profile_contract_pdf_failed': 'Could not create the PDF',
  ...
  'wallet_withdraw_section_subtitle':
      'Enter the amount and card number — admins will review it shortly.',
  'wallet_card_number_label': 'Card number',
  'wallet_withdraw_button': 'Submit',
  'wallet_withdraw_submitting': 'Submitting…',
  'wallet_withdraw_success': 'Request sent. Admins will review it shortly.',
  'wallet_withdraw_failed': 'Could not submit the withdrawal request.',
  'wallet_withdraw_insufficient': 'Insufficient wallet balance.',
  'wallet_withdraw_enter_card': 'Enter a card number (16 digits).',
  'wallet_withdraw_enter_amount': 'Enter the withdrawal amount.',
  'wallet_withdraw_amount_too_high':
      'Amount must not exceed your current balance.',
  'wallet_withdrawals_title': 'Withdrawal requests',
  'wallet_withdrawal_status_pending': 'Pending',
  'wallet_withdrawal_status_approved': 'Approved',
  'wallet_withdrawal_status_rejected': 'Rejected',
  'ar_tokens_finish_payment_notice':
  ...
  'ar_purchase_status_pending_review': 'Under review',
  'ar_purchase_status_rejected': 'Rejected',
  'ar_purchase_provider_manual': 'Card transfer',
  'ar_manual_submit': 'I have paid',
  'ar_manual_submitted':
      'Request submitted — tokens will be added after admin approval.',
  'ar_manual_failed': 'Could not submit. Please try again.',
  'ar_manual_receipt_selected': 'Receipt selected',
  'ar_purchase_provider_payme': 'Payme',
  'ar_purchase_provider_click': 'Click',
  ...
  'ar_purchase_cancel_success': 'Purchase cancelled',
  'ar_purchase_cancel_failed': 'Could not cancel. Please try again.',
...
const Map<String, dynamic> dashboardUz = {
  ...
  'leaderboard_subtitle': 'Bu hafta · muvaffaqiyatli savdolar bo\'yicha',
  ...
  'leaderboard_you': 'Siz',
  'leaderboard_view_all': 'Barchasi',
  'leaderboard_screen_title': 'Sotuvchilar reytingi',
  'leaderboard_podium_hint': 'Top 3 · mukofotlar tez orada',
  'leaderboard_rewards_soon': 'Mukofot',
  'leaderboard_empty': 'Hali reyting bo\'sh — birinchi savdoni qiling!',
  'leaderboard_load_error': 'Reytingni yuklab bo\'lmadi',
...
const Map<String, dynamic> dashboardRu = {
  ...
  'leaderboard_subtitle': 'Эта неделя · по успешным продажам',
  ...
  'leaderboard_you': 'Вы',
  'leaderboard_view_all': 'Все',
  'leaderboard_screen_title': 'Рейтинг продавцов',
  'leaderboard_podium_hint': 'Топ 3 · награды скоро',
  'leaderboard_rewards_soon': 'Награда',
  'leaderboard_empty': 'Рейтинг пока пуст — сделайте первую продажу!',
  'leaderboard_load_error': 'Не удалось загрузить рейтинг',
...
const Map<String, dynamic> dashboardEn = {
  ...
  'leaderboard_subtitle': 'This week · by successful sales',
  ...
  'leaderboard_you': 'You',
  'leaderboard_view_all': 'See all',
  'leaderboard_screen_title': 'Seller leaderboard',
  'leaderboard_podium_hint': 'Top 3 · rewards coming soon',
  'leaderboard_rewards_soon': 'Reward',
  'leaderboard_empty': 'Board is empty — make your first sale!',
  'leaderboard_load_error': 'Could not load the leaderboard',
