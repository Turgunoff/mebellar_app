...
const Map<String, dynamic> sellerEn = {
  ...
  'profile_wallet_balance_grace': 'Balance: {amount} so\'m · {hours} h left',
  'profile_wallet_balance': 'Balance: {amount} so\'m',
  ...
  'wallet_currency_som': 'som',
  'wallet_how_it_works_cta': 'How does the wallet work?',
  'wallet_credit_limit_chip': 'Credit limit: {limit} som (down to {floor})',
  ...
  'wallet_pending_topup_notice': 'Your {amount} som payment is being processed.',
  ...
  'wallet_amount_label': 'Amount (som)',
...
const Map<String, dynamic> dashboardEn = {
  ...
  'wallet_frozen_body': 'Please pay off your debt ({amount} so\'m). The store reopens automatically once the balance recovers.',
