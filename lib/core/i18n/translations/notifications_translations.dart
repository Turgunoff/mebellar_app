...
const Map<String, dynamic> profileUz = {
  ...
  'help_support_open': 'Qo\'llab-quvvatlash xizmati ochiq',
  'help_support_closed': 'Hozir yopiq',
...
const Map<String, dynamic> profileRu = {
  ...
  'help_support_open': 'Служба поддержки работает',
  'help_support_closed': 'Сейчас закрыто',
...
const Map<String, dynamic> profileEn = {
  ...
  'help_support_open': 'Support is open',
  'help_support_closed': 'Currently closed',
