...
const Map<String, dynamic> checkoutUz = {
  ...
  'delivery_deferred_range': '0 – {max} UZS (sotuvchi belgilaydi)',
...
const Map<String, dynamic> checkoutRu = {
  ...
  'delivery_deferred_range': '0 – {max} сум (устанавливает продавец)',
...
const Map<String, dynamic> checkoutEn = {
  ...
  'delivery_deferred_range': '0 – {max} UZS (set by seller)',
